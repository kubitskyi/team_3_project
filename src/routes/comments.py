...
from schemas.comments import CommentCreate, CommentUpdate, CommentResponse, RateComment
from repository.comments import create_comment, update_comment, delete_comment, get_comments_by_photo, rate_comment
